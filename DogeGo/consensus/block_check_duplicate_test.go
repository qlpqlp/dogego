...
func TestCheckBlockDuplicateTxids(t *testing.T) {
	tx := &wire.Tx{
		Version: 1,
	...
	pb := &wire.ParsedBlock{Txs: []*wire.Tx{
		{Version: 1, Vin: []wire.TxIn{{Sequence: 0xffffffff}}, Vout: []wire.TxOut{{Value: 0, PkScript: []byte{0x51}}}},
		tx, tx,
	}}
	if err := CheckBlockDuplicateTxids(pb); err == nil {
		t.Fatal("expected duplicate txid error")
	}
}
