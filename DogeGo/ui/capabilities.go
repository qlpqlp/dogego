...
func roadmapHighlights() []RoadmapHighlight {
	return []RoadmapHighlight{
		...
		{Phase: "RPC", Title: "Mining GBT/aux Core-parity cert", Done: true, Summary: "GET /api/core-mining-probe + dogego cert mining; mining GBT + createauxblock/submitauxblock; optional Core GBT side-by-side."},
