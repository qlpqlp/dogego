	...
	sections := []DocsSection{
		...
		},
		{
			...
			Links: []DocsLink{
				...
				{Label: "catalog/README.md", Path: "extensions/catalog/README.md"},
				{Label: "zkl2 USER_GUIDE", Path: "extensions/catalog/zkl2/docs/USER_GUIDE.md"},
				{Label: "zkl2 PROTOCOL", Path: "extensions/catalog/zkl2/docs/PROTOCOL.md"},
				...
				{Label: "HELLO_WORLD.md", Path: "extensions/catalog/HELLO_WORLD.md"},
				{Label: "AUTHORING.md", Path: "extensions/catalog/AUTHORING.md"},
				{Label: "BUILDING.md", Path: "extensions/catalog/BUILDING.md"},
