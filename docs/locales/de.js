(function(g){g.DogeGoSiteLocaleBundles=g.DogeGoSiteLocaleBundles||{};g.DogeGoSiteLocaleBundles["de"]={
  "meta": {
    "title": "DogeGo | Deutlich schnellerer Dogecoin-Vollknoten",
    "description": "DogeGo ist ein Open-Source-Dogecoin-Vollknoten in Go mit integriertem Web-Dashboard, Auto-Updates von GitHub, Wallet-Backup-Erinnerungen, BlockStep-Explorer, JSON-RPC und Binaries für alle wichtigen Plattformen."
  },
  "lang": {
    "aria": "Sprache wählen",
    "label": "Sprache"
  ...
  "hero": {
    "eyebrow": "Open Source auf GitHub",
    "title": "Deutlich schnellerer Dogecoin-Vollknoten",
    "lead": "Der erste Dogecoin-Vollknoten mit Post-Quantum-Commitments, zstd-Kompression, CGNAT-freundlichem Relay und einem Browser-Dashboard, das Updates prüft, Sie ans Wallet-Backup erinnert und Betreiber-Docs in der App mitliefert.",
    "download": "Download",
  ...
  "stats": {
    ...
    "testnet": {
      "value": "T-Adressen",
      "label": "Neues Reboot-Testnet"
    },
    "rpc": {
      "value": "180+",
      "label": "JSON-RPC-Methoden"
    },
    "autoupdate": {
      "value": "Auto-Update",
      "label": "GitHub-Releases-Prüfung"
    },
    "walletcare": {
      "value": "Wallet-Pflege",
      "label": "Backup-Erinnerungen · Schlüsselrotation"
    }
  },
  "demo": {
    "aria": "Interaktive DogeGo-Dashboard-Vorschau",
    "updateBanner": "Update verfügbar - DogeGo <strong>0.2.0</strong> auf GitHub Releases",
    "full": "voll",
    "mainnet": "mainnet",
    "english": "English",
    ...
    "overviewSub": "Live-Knotenmetriken von dieser Maschine.",
    "searchPlaceholder": "Höhe, Hash, Txid oder Adresse⬦",
    "searchBtn": "Suchen",
    "kpiNodeHealth": "Knotengesundheit",
    "kpiHeaderTip": "Header-Spitze",
    "kpiSync": "Sync",
    "kpiMempool": "Mempool",
    "kpiPeers": "Peers",
    "kpiTxProcessed": "Tx verarbeitet",
    "kpiChainDisk": "Chain-Festplatte",
    "chipBundled": "gebündelt",
    "chipZstd": "zstd",
    "chipTxIndex": "Tx-Index",
    "chipIbdOptimize": "IBD optimize",
    "chipP2pBoth": "P2P beides",
    "blockstepTitle": "BlockStep",
    "blockstepSub": "Durchlaufen Sie die Dogecoin-Chain von 2013 bis heute.",
    "blockstepYear2013": "2013",
    "blockstepSynced": "Synchronisiert",
    "blockstepRange": "Dez. 2013 bis sync-Spitze",
    "blockstepYearTip": "Spitze",
    "blockstepOpenBlock": "Diesen Block öffnen",
    ...
    "featuresTitle": "Funktionen & Parität",
    "featuresSub": "Live-RPC-Fähigkeitsmanifest und Betreiber-Cert-Sonden.",
    "featuresPillAuxpow": "AuxPoW Core-Parität",
    ...
    "syncDockMeta": "Verbunden <strong>{connected}</strong> · Gespeichert <strong>{stored}</strong> · Rückstand <strong>{behind}</strong>",
    ...
    "explainer": {
      "overview": {
        "title": "�Sbersicht: Betreibermetriken + Suche",
        "body": "Knotengesundheits-KPIs mit Chart.js-Sparklines, Chain-Festplattenaufschlüsselung und Suchleiste für Höhe, Hash, Txid oder Adresse. GitHub-Auto-Update-Banner, wenn ein Release neuer als Ihr Build ist. Das feste Sync-Dock zeigt verbundene vs. gespeicherte Bodies, Assist-Pool und IBD-ETA.",
        "tags": [
          "Auto-Update",
          "Sparkline-KPIs",
          "Sync-Dock",
      ...
      "blockstep": {
        "title": "BlockStep: Zeitachse vom Genesis zur Spitze",
        "body": "Durchsuchen Sie die Dogecoin-Geschichte von Dezember 2013 bis zur sync-Spitze. �ffnen Sie jeden Block im Explorer, prüfen Sie Coinbase und PQ-OP_RETURN-Ausgaben und springen Sie mit einem Klick zwischen Epochen. BlockStep teilt denselben Tx-Index wie die Dashboard-Suche.",
        "tags": [
          "Tx-Index",
          "Zeitachsen-Scrub",
          "PQ-Explorer"
      ...
      "mempool": {
        "title": "Mempool-Richtlinie zum Inspizieren",
        "body": "Wartende Transaktionen mit Feerate, Standardness und BIP125-RBF-Status. Paketlimits, Min-Relay-Fee und Full RBF entsprechen Core-Flag-Namen in dogecoinconf.json. Live-Paritätssonden vergleichen testmempoolaccept-Zeilen mit Dogecoin Core, wenn konfiguriert.",
        "tags": [
          "BIP125 RBF",
          "Paketlimits",
          "Core-Paritätssonde"
      ...
      "features": {
        "title": "Funktionen-Tab: Fähigkeiten & Cert-Matrix",
        "body": "Live-RPC-Fähigkeitsmanifest, OpenRPC unter /api/openrpc.json und Betreiber-Cert-Sonden (AuxPoW-Parität, Mempool-Korpus, Restart-Resume, Founder-Checks). Einstellungen können eine Side-by-Side-Core-Verbindung testen und Ergebnisse 90 Sekunden cachen.",
        "tags": [
          "OpenRPC",
          "Core-Vergleich",
          "Betreiber-Certs"
  ...
  "console": {
    "title": "Vom Terminal aus starten",
    "lead": "DogeGo ist ein einzelnes Go-Binary. Von GitHub Releases herunterladen oder aus Quellcode bauen, dann den Knoten starten. Dashboard und JSON-RPC starten automatisch.",
    "step1Title": "Herunterladen oder bauen",
    "step1Body": "<code>cd DogeGo && go build -o dogego ./cmd/dogego</code>",
    "step2Title": "Knoten starten",
    "step2Body": "<code>./dogego</code> oder <code>./dogego node -network mainnet</code>",
    "step3Title": "Dashboard öffnen",
    "step3Body": "Browser unter <code>localhost:2013</code>. Erster Start öffnet den Setup-Assistenten.",
    "note": "P2P-User-Agent kündigt <code>/DogeGo:0.1.0-beta/</code> im Netzwerk an. Nicht Shibetoshi, nicht Core.",
    ...
    "lines": [
      ...
      "Speicher: gebündelte blk*.dat + zstd · kompakter Tx-Index",
      "Update-Check: github.com/qlpqlp/dogego/releases (täglich)",
      "Wallet aktiviert · BIP44 HD · Dashboard-PIN optional",
      "IBD 68,4 % · Header 5.412.884 · Bodies holen auf ⬦",
  ...
  "features": {
    "title": "Mehr als Dogecoin Core",
    "lead": "DogeGo liefert Betreiber-Tools, Indexierung und moderne Netzwerkmodi, die Core nie gebündelt hat, in einem Go-Binary mit Browser-Dashboard.",
    "items": {
      "pq": {
        "title": "Post-Quantum-Commitments",
        "body": "Erster Dogecoin-Vollknoten mit Phase-1-PQ-OP_RETURN-Trägern (FLC1, DIL2, RCG4). Senden mit automatischen Wallet-Commitments, verifizieren via <code>dogego_verifypqcommitment</code> und im Explorer inspizieren."
      },
      "zstd": {
        "title": "zstd-Blockkompression",
        "body": "Optionales zstd auf gespeicherten Block-Bodies plus gebündeltes <code>blk*.dat</code>-Layout. Core behält rohe Blöcke unkomprimiert. DogeGo meldet Kompressionsrate und Festplattenersparnis im Dashboard."
      },
      "spv": {
        "title": "Vollknoten oder SPV",
        "body": "Headers-first-IBD mit voller Validierung oder leichtes SPV (nur Header) für minimalen Speicher. Gleiches Binary, gleicher Assistent. Profil beim ersten Start wählen."
      },
      "cgnat": {
        "title": "CGNAT- & Starlink-Relay",
        "body": "P2P-Modi: <code>classic</code>, <code>cgnat</code> (nur ausgehend) oder <code>both</code>. Bis zu 12 ausgehende Peers leiten Blöcke ohne eingehende Portweiterleitung weiter - für Carrier-NAT und Starlink."
      },
      "testnet": {
        "title": "Reboot-Testnet",
        "body": "Frisches Testnet mit Adressen ab <strong>T</strong> (für Test). Echtes Scrypt-PoW wie Core (RelaxedPoW aus). Digishield-Min-Diff hilft Solo-Mining bei niedriger Hashrate. Port <code>44556</code>."
      },
      "search": {
        "title": "Alles durchsuchen",
        "body": "Vollständiger Tx-Index standardmä�xig. Suche Höhe, Block-Hash, Txid oder Adresse vom Dashboard. Dogecoin ist ein öffentliches Ledger, und DogeGo macht jeden Eintrag leicht auffindbar."
      },
      "dashboard": {
        "title": "Web-Dashboard",
        "body": "Loopback-UI unter <code>:2013</code>: KPI-Karten, Auto-Update-Banner, Sync-Dock, Mempool, Analytik, eingebettete Docs, Funktionen-Cert-Matrix und fünfstufiger Setup-Assistent. Keine Qt-Installation nötig."
      },
      "rpc": {
        "title": "180+ JSON-RPC-Methoden",
        "body": "Core-kompatibles HTTP-JSON-RPC mit Cookie-Auth, ZMQ-Benachrichtigungen, OpenRPC unter <code>/api/openrpc.json</code> und Live-Fähigkeitsflags im Funktionen-Tab."
      },
      "wallet": {
        "title": "Integriertes HD-Wallet",
        "body": "Senden, Empfangen und Verlauf mit BIP44-HD-Wallet, PIN-Entsperrung, optionale WebAuthn-Biometrie, Coin Control, Gebührenhinweise, PSBT mit BIP32-Ableitungspfaden, optionaler HWI-Externsigner und Core-wallet.dat-Migration (Sonde + native BDB-Import, verschlüsselt via Passphrase)."
      },
      "autoupdate": {
        "title": "Integriertes Auto-Update",
        "body": "Der Knoten prüft <a href=\"https://github.com/qlpqlp/dogego/releases\">GitHub Releases</a> täglich auf Semver-Tags neuer als Ihr Build. �Sbersicht und Einstellungen zeigen ein Banner mit Release-Notes und direktem Binary-Download, wenn ein passendes Plattform-Asset existiert."
      },
      "backup": {
        "title": "Wallet-Backup-Erinnerungen",
        "body": "Ersteinrichtung erfordert Download von <code>wallet.json</code> vor dem Start. Auf Empfangen erinnert ein wiederkehrendes Banner ans Offline-Backup - 30 Tage ausblenden oder HD-Schlüssel mit geführtem Sweep in ein neues Wallet rotieren."
      },
      "dgr": {
  ...
  "fullnode": {
    ...
    "lead": "Headers-first IBD, Go-nativer Speicher, Core-kompatibles JSON-RPC und Operator-Tools in einer Binary. Mainnet-Konsens folgt Dogecoin Core (keine Protokoll-Forks).",
  ...
  "care": {
    "title": "Betreibererfahrung eingebaut",
    "lead": "DogeGo ist mehr als Sync und RPC - das Loopback-Dashboard enthält Alltags-Tools, die Core nie an einem Ort mitgeliefert hat.",
    "items": {
      "releases": {
        "title": "Release-Benachrichtigungen",
        "body": "Täglicher Update-Check gegen das kanonische Repo <code>github.com/qlpqlp/dogego</code>. CLI gibt auch Hinweise aus; pro Release in der Web-UI oder via <code>POST /api/update/dismiss</code> verwerfen."
      },
      "backup": {
        "title": "Backup-Stups alle 30 Tage",
        "body": "Empfangen-Tab zeigt ein Wallet-Backup-Banner, bis Sie eine Kopie herunterladen oder 30 Tage schlummern. Setup-Assistent blockiert <strong>Speichern & starten</strong>, bis Backup bestätigt ist, wenn Wallet aktiv."
      },
      "rotation": {
        "title": "HD-Schlüsselrotation",
        "body": "Ein-Klick vorbereiten -> sweep -> verifizieren -> finalisieren verschiebt Ihr Guthaben in ein neues BIP44-Wallet und archiviert alte Schlüssel - Backup zuerst erforderlich."
      },
      "autostart": {
        "title": "OS-Login-Autostart",
        "body": "Bei Anmeldung registrieren unter Windows (Aufgabenplanung), Linux (systemd user) oder macOS (LaunchAgent). Assistent und Funktionen-Tab führen dieselben Sonden wie <code>dogego cert autostart</code> aus."
      },
      "txflight": {
        "title": "Tx-Flight-Sende-Leiste",
        "body": "Animierter Fortschritt beim Senden: Signieren, Broadcast, Mempool-Warten und Bestätigung - mit Ein-Klick-Sprung zu Verlauf oder Block-Explorer."
      },
      "i18n": {
        "title": "Sechs Dashboard-Sprachen",
        "body": "English, Deutsch, Français, Português, ���S��~ und 中�! - Assistent und Dashboard teilen denselben Sprachwähler in der oberen Leiste."
      },
      "pin": {
        "title": "PIN- & WebAuthn-Sperre",
        "body": "Optionale 6-stellige Dashboard-PIN bei Setup oder in Einstellungen. Mit Geräte-Biometrie (WebAuthn) Senden und Wallet-Ansichten ohne ständiges Neutippen entsperren."
      },
      "docs": {
        "title": "Eingebetteter Docs-Tab",
        "body": "Betreiber-Runbooks, Integrationsleitfäden und Repo-Markdown im Browser via <code>GET /api/docs</code> - kein GitHub-Tab nötig beim Feintuning des Knotens."
      },
      "cert": {
        "title": "Live-Cert-Matrix",
        "body": "Funktionen-Tab zeigt Core-Paritätszähler, OpenRPC unter <code>/api/openrpc.json</code> und zehn Live-Betreiber-Sonden (compare, mempool, autostart, founder, restart-resume, end-to-end)."
      },
      "syncdock": {
      ...
      "firewall": {
        ...
        "body": "Setup-Assistent führt automatische Checks für Ports, CGNAT-Hinweise und optionale OS-Firewall-Regeln aus. Copy-Paste-Befehle mit erhöhten Rechten erscheinen in �Sbersicht, wenn Handlung nötig ist."
      },
      "history": {
        "title": "Skalierbarer Verlauf",
        "body": "Unendlich scrollender Transaktionsfeed mit serverseitiger Suche und Typfiltern, CSV-Export, UTXO-Cache-Fast-Path für Solo-Miner und sanftes Refresh, das Scrollposition erhält."
      },
      "extensions": {
  ...
  "blockstep": {
    "title": "BlockStep: Dogecoin auf unterhaltsame Weise erkunden",
    "lead": "Da Dogecoin ein öffentliches Ledger ist, sollte jeder Block und jede Transaktion leicht zu finden sein. DogeGo indexiert die Chain und BlockStep macht daraus eine interaktive Zeitachse.",
    "labelGenesis": "Genesis 2013",
    "labelHalving": "Joke era",
    "labelToday": "Heute",
    "labelTip": "Spitze",
    "listSearch": "Suche nach Höhe, Hash, Txid oder Adresse von �Sbersicht oder Explorer",
    "listTimeline": "BlockStep-Zeitachse: vom Genesis zur Spitze scrubben, in jeden Block eintauchen",
    "listIndex": "Flacher <code>indexes/tx/</code>-Index, nicht Cores chainstate-Layout",
    "listPq": "PQ-Explorer-Panel: Post-Quantum-Commitment-Skripte inspizieren"
  },
  "wizard": {
    "title": "Fünfstufiger Setup-Assistent",
    "lead": "Erster Start öffnet einen geführten Assistenten unter <code>/setup</code>. Profil wählen, automatische Preflight-Checks, gebündelt+zstd-Speicher konfigurieren, dann speichern mit optionaler PIN, OS-Autostart und Wallet-Backup.",
    ...
    "progressAria": "Setup-Fortschritt",
    "panels": {
      "profileTitle": "Setup wählen",
      ...
      "profileTryTestnetSub": "Vollknoten · Wallet an · ideal für ersten Start",
      "profileMainnetFull": "Mainnet-Vollknoten",
      "profileMainnetFullSub": "Produktions-Dogecoin · längere Sync, volle Validierung",
      ...
      "advancedToggle": "Erweiterte Optionen in späteren Schritten anzeigen",
      ...
      "dataTestnet": "Testnet",
      "dataTestnetSub": "Sichere Sandbox",
      "dataMainnet": "Mainnet",
      "dataFullNode": "Vollknoten",
      "dataFullNodeSub": "Header + Bodies",
      "dataSpv": "SPV (leicht)",
      "dataFoot": "Peer leer gelassen -> automatische DNS- + addrman-Erkennung.",
      "networkTitle": "Netzwerk & P2P",
      "networkHint": "Konnektivität, Firewall, UPnP und automatischer Preflight vor der Sync.",
      "networkBoth": "Beides",
      ...
      "preflightUpnp": "UPnP auto beim Lauschen",
      "syncTitle": "Sync & Speicher",
      "syncHint": "Empfohlene Defaults: gebündelte <code>blk*.dat</code>, zstd-Kompression, kompakter Tx-Index.",
      "syncBundled": "Gebündelter Blockspeicher",
      "syncZstd": "Gespeicherte Blöcke komprimieren (zstd)",
      "syncTxIndex": "Transaktionsindex",
      "syncEmbedTx": "Volle Tx-Bytes im Index einbetten",
      "syncAnalytics": "Analytik-Sidecar (Pebble)",
      "syncIbdOptimize": "Optimize initial block download",
      "syncDbcache": "DB cache / UTXO (auto RAM)",
      "syncOn": "an",
      "syncOff": "aus",
      "syncFoot": "Block-Sync-Worker: automatisch (2-6 Peers während IBD).",
      "finishTitle": "Fertigstellen & starten",
      "finishHint": "Dashboard-Sicherheit, OS-Autostart, Wallet-Backup und Config-Zusammenfassung.",
      ...
      "finishReview": "testnet · voll · P2P both · gebündelt+zstd · Wallet an",
      "finishStartBtn": "Speichern & Knoten starten"
    },
    "list": {
      "i18n": "Sechs UI-Sprachen (English, Deutsch, Français, ���S��~, 中�!, Português)",
      "preflight": "Automatischer Preflight - Firewall, Ports, CGNAT-Hinweise, Founder-Checks auf Reboot-Testnet",
      "backup": "Wallet-Backup-Gate am Ende; Empfangen-Tab erinnert alle 30 Tage bis Download oder Verwerfen",
      "autostart": "OS-Login-Autostart mit <code>dogego cert autostart</code>-Paritätssonden",
  ...
  "compare": {
    "title": "Warum Betreiber DogeGo wählen",
    ...
    "rows": {
      ...
      "blockstepExplorer": {
        ...
        "doge": "Interaktive Zeitachse",
        "core": "Kein gebündelter Explorer"
      },
      "postQuantum": {
        "cap": "Post-Quantum-Sends",
        "doge": "FLC1/DIL2/RCG4-Commitments",
        "core": "Nicht verfügbar"
      },
      "zstdCompression": {
        "cap": "zstd-Blockkompression",
        "doge": "Optional, mit Ratio-Metriken",
        "core": "Unkomprimierte blocks/"
      },
      "cgnatRelay": {
        "cap": "CGNAT / Starlink-Relay",
        "doge": "Ausgehende Multi-Peer-Modi",
        "core": "Eingehende Ports nötig"
      },
      "spvMode": {
        "cap": "SPV-Modus",
        "doge": "Nur-Header-Profil",
        "core": "Separate Tools"
      },
      "analyticsSidecar": {
        "cap": "Analytik-Sidecar",
        "doge": "Pebble-Charts in der UI",
        "core": "Externes Tooling"
      },
      "testnetAddresses": {
      ...
      "walletBackupCare": {
        ...
        "doge": "Setup-Gate · 30-Tage-Erinnerungen · Schlüsselrotation",
        "core": "Betreiber-Verantwortung"
      },
      "osAutostart": {
        "cap": "OS-Autostart",
        "doge": "Login-Autostart + Cert-Sonden",
        "core": "Manuelles Service-Setup"
      },
      "dashboardI18n": {
        "cap": "Dashboard-i18n",
        "doge": "6 Sprachen in Assistent + UI",
        "core": "Nur englisches Qt"
      },
      "coreSideBySide": {
      ...
      "coreWalletMigration": {
        ...
        "doge": "Native BDB-Sonde · Import · verschlüsselte Passphrase · Core-RPC-Fallback",
        "core": "Natives wallet.dat-Format"
      },
      "productionCertification": {
        "cap": "Produktionszertifizierung",
        "doge": "In Arbeit (Beta)",
        "core": "Etabliert"
      }
    }
  ...
  "networks": {
    ...
    "rows": {
      ...
      "configFile": {
        ...
        "value": "dogecoinconf.json in Ihrem Datenverzeichnis"
      },
      "testnetAddresses": {
        "service": "Testnet-Adressen",
        "value": "Reboot-Testnet: alle P2PKH-Adressen beginnen mit T (Präfix 0x41)"
      }
    }
  },
  "download": {
    "title": "DogeGo herunterladen",
    "lead": "Vorgebaute Binaries für jede von Go unterstützte Plattform.",
  ...
  "developers": {
    ...
    "lead": "Integrieren Sie mit denselben JSON-RPC-Formen, die Sie bereits mit Dogecoin Core nutzen.",
    "openrpc": {
  ...
  "footer": {
    "tagline": "Deutlich schnellerer Dogecoin-Vollknoten, in Go geschrieben und vom Browser aus betrieben.",
    "uaLabel": "P2P-User-Agent",
    "uaNote": "Kündigt als DogeGo im Netzwerk an. Nicht Shibetoshi, nicht Core. Optionaler Kommentar: <code>/DogeGo:0.1.0-beta(Ihre-Notiz)/</code>",
    "productHeading": "Produkt",
    "productFullnode": "Full node",
    "productRoadmap": "Roadmap",
    "productFeatures": "Funktionen",
    "productCare": "Betreiber-Pflege",
    "productBlockstep": "BlockStep",
    "productWizard": "Setup-Assistent",
    "productVsCore": "vs Core",
    "productDownload": "Download",
    "devHeading": "Entwickler",
    "devRpc": "JSON-RPC",
    "devGithub": "GitHub",
  ...
  "guide": {
    ...
    "toc": "Doku-Menü",
    "tocOpen": "Dokumentationsmenü öffnen",
    "tocClose": "Dokumentationsmenü schließen"
  }
};})(window);
